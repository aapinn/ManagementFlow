...
export default function Pengeluaran() {
  ...
  return (
    <div className="page page-animate" style={{ '--section-gradient': 'var(--expense-gradient)' } as React.CSSProperties}>
      <div className="page-header">
        ...
        <div className="page-summary">
          <span className="summary-label" style={{ background: 'var(--expense-bg)', color: 'var(--expense)', padding: '4px 12px', borderRadius: 8, display: 'inline-block' }}>Total Pengeluaran</span>
          <span className="summary-value" style={{ color: 'var(--expense)' }}>{formatRp(animTotal)}</span>
        </div>
      </div>
      ...
      <div className="card" style={{ marginTop: 20, '--section-gradient': 'var(--expense-gradient)' } as React.CSSProperties}>
          ...
          <table className="table">
            ...
            <tbody>
              {sorted.length === 0 ? (
                ...
                (paged as unknown as Expense[]).map((t) => (
                  <tr key={t.id}>
